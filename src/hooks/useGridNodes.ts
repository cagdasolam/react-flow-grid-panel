...
//         // Position IS the center (CSS translate(-50%, -50%) handles rendering).
//         // Simply snap position to grid and compute relative as position diffs.
...
//                 ...node.data,
//                 gridCoords: {
//                   rX: node.data?.isRoot ? 0 : snappedData.relativeX,
//                   rY: node.data?.isRoot ? 0 : snappedData.relativeY,
//                 },
//               },
//             };
//           }

//           // If root is being dragged, update its position
...
//           // If root is dragged, update children's relative coordinates
//           if (draggedNode.id === "root" && !node.data?.isRoot) {
...
//    * Position IS the center, so relative = position diff / gridSize
//    */
